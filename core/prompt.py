...
def build_stable_system_prompt(
    ...
    base_prompt += (
        ...
        "CRITICAL: Do NOT use write_file or delete_file to create, modify, or delete user profiles, memory files (SOUL.md, IDENTITY.md, MOOD.md, RELATIONSHIPS.md, MEMORY.md), or daily journals. Always use the specified XML tags (e.g., <save_user>, <save_soul>, <save_identity>, <save_mood>, <save_relationship>, <save_memory>, or <log_memory>) to update these states. Direct tool writes to the 'persona/' directory are blocked.\n"
