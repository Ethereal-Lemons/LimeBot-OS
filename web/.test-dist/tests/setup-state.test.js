...
import { clearSetupProgress, loadSetupProgress, normalizeSetupError, saveSetupProgress, setupRetryDelay, } from "../src/lib/setup-state.js";
...
test("retry delay is bounded exponential backoff", () => {
    ...
    assert.equal(setupRetryDelay(1), 1000);
    assert.equal(setupRetryDelay(10), 3000);
});
