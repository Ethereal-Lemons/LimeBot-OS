...
import { normalizeAgentReadiness, readinessLabel, } from "../src/lib/agent-readiness.js";
...
test("phase labels explain required startup work", () => {
    ...
    assert.equal(readinessLabel(normalizeAgentReadiness({ status: "failed", phase: "failed" })), "Required capabilities failed to load");
});
